...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{figures/JDK.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/intellij.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/git.jpeg}
    \caption{logo de Git}
    \label{fig:git_logo}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/github.jpeg}
...
Dans ce projet, GitHub a servi de dépôt centralisé pour le code source et a facilité le déploiement continu vers la plateforme cloud.

\subsection{Railway (Plateforme Cloud)}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/Railway.jpeg}
